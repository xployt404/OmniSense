...
OmniSense is a comprehensive security and motion monitoring system (Demo). It features a high-performance Go-based central hub, ESP8266-powered motion sensors, and a real-time web dashboard for visualization, analytics, and system management.
